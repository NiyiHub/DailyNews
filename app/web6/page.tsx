        ...
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <div className="prose prose-gray mx-auto">
            <p className="text-lg leading-relaxed">
              ...
              is custom-designed and trained for algorithmic news curation and 
              AI-generated content.
              Our AI-powered news platform operates through an algorithm, 
              transforming how news is gathered, created, and disseminated. This 
              intelligent system filters information, generates story ideas, 
              conducts digital newsgathering, and crafts news content. By 
              integrating these measures, Daily News aims to redefine modern 
              journalism through the use of cutting-edge artificial intelligence, 
              thereby minimizing errors and promoting open news reporting.
            </p>
          </div>
