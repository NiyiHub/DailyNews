        ...
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <div className="prose prose-gray mx-auto">
            <p className="text-lg leading-relaxed">
              ...
              Our AI-powered news platform enables full transparency of our 
              news production processes and aims to redefine modern journalism 
              by combining cutting-edge artificial intelligence with a steadfast 
              commitment to reliable and open news reporting.
            </p>
          </div>
